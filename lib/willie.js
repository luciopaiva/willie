...
var
    ...
    LEVELS = {
        ...
        _INFO:   { tag:    'info', index: 3, color: 'green' }, // necessary because winston.profile uses info() internally
        INFO:    { tag: '   info', index: 4, color: 'green' },
        WARN:    { tag: '   warn', index: 5, color: 'yellow' },
        ERROR:   { tag: '  error', index: 6, color: 'red' }
    },
...
function resolveIndent() {
    ...
    for(i = 0; i < indentLevel; i++) {
        indentStr += (i % 2) ? indentConstOdd : indentConstEven;
    }
}
